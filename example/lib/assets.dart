...
class I18n {
  ...
  String stringWithPlaceholder(String placeholder) {
    return customLookup?.stringWithPlaceholder(placeholder) ??
        _lookup.stringWithPlaceholder(placeholder);
  }
...
class I18nLookup {
  ...
  String stringWithPlaceholder(String placeholder) {
    return getString(
        I18nKeys.stringWithPlaceholder, {"placeholder": placeholder});
  }
...
class Images {
  /// lib/assets/extension.png
  static const AssetImage extension = AssetImage("lib/assets/extension.png");
}
